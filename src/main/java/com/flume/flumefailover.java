...
public class flumefailover {
  public static void main(String[] args) {
    MySecureRpcClient client = new MySecureRpcClient();
...
//                                                // selection
    props.put("max-attempts", "3"); // # Must be >=0 (default: number of hosts.
